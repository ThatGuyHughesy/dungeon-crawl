...
character_races = CharacterRace.create([{ id: 1,
                                          name: 'Dwarf',
...
character_classes = CharacterClass.create([{ id: 1,
                                             name: 'Barbarian' },
                                           { id: 2,
                                             name: 'Bard' },
                                           { id: 3,
...
campaign = Campaign.create(id: 1,
                           name: 'Adventure Call',
                           description: 'My name is Falconhoof and I will be your guide on your quest')

campaign.users << user

character = Character.create(id: 1,
                             name: 'Jingle The Jester',
                             character_race_id: 4,
